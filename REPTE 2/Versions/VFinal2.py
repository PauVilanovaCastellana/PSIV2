...
def procesar_video():
    ...
    contador_arriba = 0
    contador_abajo = 0
    ruta_video = "output6.mp4"
    ruta_video_tracking = "trackingVFinal2_" + os.path.basename(ruta_video)
    ...
    while True:
        ...
        cv.line(frame, (0, linea_conteo_y), (ancho_deseado, linea_conteo_y), (0, 255, 255), 2)
