...
def procesar_video():
    ...
    ruta_video_tracking = "trackingV6_" + os.path.basename(ruta_video)  # Nombre para el video de seguimiento
    ...
    while True:
        ...
        # Solo procesar un frame de cada 15
        if frame_count % 10 != 0:
            continue
        ...
        for rastro in rastros:
            ...
            if track_id not in ultima_posicion:
                ...
                print(track_id, coordenada_y_caja,desplazamiento)
                        ...
                        if objetos_tocaron_linea[track_id]:
                            if posicion_anterior_y > linea_conteo_y >= coordenada_y_caja:
                                ...
                                if ultima_direccion[track_id] != "arriba":
                                    ...
                                    print("AAAAAAAAAA",track_id, coordenada_y_caja, desplazamiento)
                                ...
                                if ultima_direccion[track_id] != "abajo":
                                    contador_abajo += 1
                                    ultima_direccion[track_id] = direccion
                                    print("BBBBBBBBBB",track_id, coordenada_y_caja)
