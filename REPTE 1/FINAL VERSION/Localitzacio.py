...
def procesar_y_enderezar_letras(img_crop):
    ...
    if angulo < -45:
        angulo += 90  # Corregir el rango del ángulo para rotar
    elif angulo > 45:
        angulo -= 90
    ...
    # Matriz de rotación para rotar la imagen
    M = cv2.getRotationMatrix2D(centro, angulo, 1.0)
    
    # Rotar la imagen para enderezar las letras
