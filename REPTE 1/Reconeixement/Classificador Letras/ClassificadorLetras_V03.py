...
def create_feature_extractor():
    model = models.Sequential([
        ...
        layers.Conv2D(32, kernel_size=(3, 3)),  # Convolución sin activación
        layers.BatchNormalization(),  # Normalizamos antes de ReLU
        layers.ReLU(),  # Activación ReLU
        layers.MaxPooling2D(pool_size=(2, 2)),

        layers.Conv2D(64, kernel_size=(3, 3)),  # Convolución sin activación
        layers.BatchNormalization(),  # Normalizamos antes de ReLU
        layers.ReLU(),  # Activación ReLU
        layers.MaxPooling2D(pool_size=(2, 2)),
        ...
        layers.BatchNormalization() , # Capa BatchNormalization correctamente aplicada
