# -*- coding: utf-8 -*-
"""
Created on Thu Sep 26 09:44:47 2024
...
def procesar_imagen(img_path, output_dir):
    ...
    caracteres_recortados=recortar_caracteres(imagen_dilatada)
    ...
    mostrar_imagen_con_caracteres(imagen_dilatada, caracteres_recortados)
