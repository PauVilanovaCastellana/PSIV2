...
def evaluate_patch_classification(k_patient_ids, k_labels, data_folder, model):
    roc_save_path = "/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/PatchClassification_k_154_Validation06.png"
    boxplot_save_path = "/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/F_Red_Distribution_Boxplot_Validation06.png"
...
def evaluate_patient_diagnosis(k_patient_ids, k_labels, data_folder, model, patch_threshold, show = True):
    save_path= "/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/PatientDiagnosis_k_154_Validation06.png"
    patient_labels = []
    patient_predictions = []
...
def cross_validate_system(patient_ids, labels, data_folder, model, n_splits=15, save_excel_path="/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Cross_Validation_Metrics_with_Thresholds_Validation06.csv"):
    ...
    for fold, (train_idx, test_idx) in enumerate(gkf.split(patient_ids, labels, groups=patient_ids), start=1):
        ...
        plt.tight_layout()
        plt.savefig(f"/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Conf_Matrix_fold_{fold}_Validation06.png")
        plt.close()
        print(f"Confusion matrix for fold {fold} saved to /export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Conf_Matrix_fold_{fold}_Validation06.png")
    ...
    plt.ylabel("True Labels")
    plt.tight_layout()
    plt.savefig("/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Overall_Conf_Matrix_Validation06.png")
    plt.close()
    print(f"Overall confusion matrix saved to /export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Overall_Conf_Matrix_Validation06.png")
    ...
    plt.tight_layout()
    plt.savefig("/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Average_Metrics_Validation06.png")
    plt.close()
    print("Metrics plot saved to /export/fhome/maed01/myvirtualenv/AutoEncoder/Images/CalidadDeLaBuena/Average_Metrics_Validation06.png")
