...
def evaluate_patch_classification(k_patient_ids, k_labels, data_folder, model):
    roc_save_path = "/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/PatchClassification_k_154_Validation.png"
    boxplot_save_path = "/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/F_Red_Distribution_Boxplot.png"
...
def evaluate_patient_diagnosis(k_patient_ids, k_labels, data_folder, model, patch_threshold):
    save_path="/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/PatientDiagnosis_k_154_Validation.png"
    """
...
def cross_validate_system(patient_ids, labels, data_folder, model, n_splits=5, save_plot_path="/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/Metrics_154.png"):
    ...
    for train_idx, test_idx in gkf.split(patient_ids, labels, groups=patient_ids):
      ...
      # Convertir predicciones continuas a etiquetas binarias
      test_preds_binary = [1 if pred >= patient_threshold else 0 for pred in test_preds]
      
      # Calcular métricas de clasificación
      recall_0 = recall_score(test_labels, test_preds_binary, pos_label=0)
      recall_1 = recall_score(test_labels, test_preds_binary, pos_label=1)
      precision_0 = precision_score(test_labels, test_preds_binary, pos_label=0)
      precision_1 = precision_score(test_labels, test_preds_binary, pos_label=1)
      f1_0 = f1_score(test_labels, test_preds_binary, pos_label=0)
      f1_1 = f1_score(test_labels, test_preds_binary, pos_label=1)
