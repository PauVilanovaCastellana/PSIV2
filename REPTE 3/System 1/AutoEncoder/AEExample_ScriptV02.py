...
file_path = '/export/fhome/maed01/HelicoDataSet/CrossValidation/PatientDiagnosis_17.csv'
...
if not cropped_images:
    sys.exit("Error: No se encontraron imágenes para pacientes sanos en la carpeta especificada.")
