...
cropped_images = cropped_images[:3500]
...
for image_path in cropped_images:
    ...
    if image is None:
        continue
    # Usamos el espacio de color RGB sin convertir a HSV
    resized_image = cv2.resize(image, (256, 256))  # Cambiamos el tamaño a 256x256
    normalized_image = resized_image / 255.0  # Normalizamos entre 0 y 1
...
model_path = 'autoencoder_model_V09.pth'
