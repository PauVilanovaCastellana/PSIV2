...
def evaluate_holdout_set(holdout_ids, holdout_labels, data_folder, model, patch_threshold, patient_threshold):
    ...
    plt.tight_layout()
    plt.savefig("/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/Results HoldOut/AAAAAA_HoldOut_Confusion_Matrix_Fold_prime.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/Results HoldOut/AAAAAA_HoldOut_Global_Metrics_Fold_prime.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("/export/fhome/maed01/myvirtualenv/AutoEncoder/Images/Results HoldOut/AAAAAA_HoldOut_ROC_Curve_Fold_prime.png")
    plt.close()
...
patch_threshold = 210 # 221.6
patient_threshold = 0.45 # 0.46725684795553785
