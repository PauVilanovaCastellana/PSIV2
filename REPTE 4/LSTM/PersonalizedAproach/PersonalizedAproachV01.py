...
if __name__ == "__main__":
    ...
    for fold, (train_idx, test_idx) in enumerate(skf.split(all_eeg_data, all_labels)):
        ...
        plt.ylabel("Loss")
        plt.legend()
        plt.savefig(f"{RESULTS_DIR}/loss_curves/Sense Solapament/loss_curve_fold_{fold + 1}.png")
        plt.close()
        ...
        plt.ylabel("Real")
        plt.savefig(f"{RESULTS_DIR}/confusion_matrix/Sense Solapament/confusion_matrix_fold_{fold + 1}.png")
        plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"{RESULTS_DIR}/confusion_matrix/Sense Solapament/metrics_summary.png")
    plt.close()
    ...
    plt.xlabel("Predicted")
    plt.ylabel("Real")
    plt.savefig(f"{RESULTS_DIR}/confusion_matrix/Sense Solapament/confusion_matrix_total.png")
    plt.close()
